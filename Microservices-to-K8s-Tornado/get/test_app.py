...
class TestConference(unittest.TestCase):
    ...
    def test_conference(self):
        ...
        response = self.test_app.get("http://192.168.99.100:32218/gettornado")
    ...
    def test_page_loads(self):
        ...
        response = result.get("http://192.168.99.100:32218/gettornado", content_type='html/text')
        self.assertTrue(b'Informacion Mongo' in response.data)

    def test_item_not_exist(self):
        self.test_app = a.test_client()
        response = self.test_app.get("http://192.168.99.100:32218/gettornado/paginacion/1/")
